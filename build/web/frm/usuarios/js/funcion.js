...
function validarFormulario() {
    ...
    if ($("#login_usuario").val().trim() === "") {
        valor = false;
        $("#mensajes").html("Login no puede estar vacio.");
        $("#login_usuario").focus();
    }
    if ($("#password_usuario").val().trim() === "") {
        valor = false;
        $("#mensajes").html("Contraseña no puede estar vacio.");
...
function buscarpasswordrepetido() {
    var datosFormulario = $("#formPrograma").serialize();
    $.ajax({
        type: 'POST',
        url: 'jsp/buscarpasswordrepetido.jsp',
        data: datosFormulario,
        dataType: 'json',
        beforeSend: function (objeto) {
            $("#mensajes").html("Enviando datos al servidor...");
        ...
        success: function (json) {
            ...
            $("#password_usuario").focus();
            if ($("#password_usuario").val().trim() === "") {
                $("#mensajes").html("La contraseña es repetido");
                $("#password_usuario").focus();
                 $("#mensajes").html(json.mensaje);
