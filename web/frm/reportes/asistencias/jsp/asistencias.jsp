...
<%
    ...
    int grado=Integer.parseInt(request.getParameter("g"));
    int seccion=Integer.parseInt(request.getParameter("s"));
    int asignatura=Integer.parseInt(request.getParameter("a"));
